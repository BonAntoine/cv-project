...
const threeSceneLoaded = ref(false);

function finishLoading() {
    threeSceneLoaded.value = true;
}
...
<template>
    ...
    <div v-show="threeSceneLoaded">

        <ThreeBackground @finishLoading="finishLoading" :overed="overed" :step="step" :categories="categories">
        </ThreeBackground>
    ...
    <div v-if="!threeSceneLoaded">
        <div class="h-screen w-screen flex flex-col justify-center items-center">
            <div class="text-4xl mb-8">Loading...</div>
